...
public class ColorPointInherit extends Point {
	/*	extends ettigi icn equals methodunu yazamayiz 
	 * 	cunku,  Broken - violates symmetry!  simetrigi bozuyor
	 *  simetrigi cozup karmasik bir equals yazdiginizda da 
	 *  donusumlulu bozuyor - Broken - violates transitivity!
	 */
